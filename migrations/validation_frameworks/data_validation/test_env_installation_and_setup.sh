...
sudo //usr/bin/pip3 install sqlalchemy
sudo aws s3 sync s3://nurix-dev-072287052099/migration/qa/data_validation /home/hadoop
sudo aws s3 sync s3://nurix-dev-072287052099/migration/qa/data_validation/jars //lib/spark/jars